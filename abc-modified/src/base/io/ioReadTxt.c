/**CFile****************************************************************
  ...
  Revision    [$Id: ioReadTxt.c,v 1.00 2005/06/20 00:00:00 alanmi Exp $]
...
/**Function*************************************************************
  ...
  Synopsis    [Reads and does nothing with txt file.]
...
***********************************************************************/
Abc_Ntk_t * Io_ReadTxt( char * pFileName, int fCheck )
{
    Abc_Ntk_t * pNtk;
    FILE * pFile;
    char * pContents;
   ...
   // unsigned * pBufferNode;
    ...
    printf ("The contents of pContents is %s \n\n", pContents);
...
//Io_WriteVerilog( pNtk, "_temp.v" );
  ...
  printf( "Testing:Just reading the txt file and returning it to pContents.\n" );
  return pNtk;
